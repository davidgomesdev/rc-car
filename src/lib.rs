...
impl CarCommand {
    ...
    pub fn drive(speed: i8, max_duty: u32) -> Self {
        ...
        Self { front_left: cmd, front_right: cmd, rear_left: cmd, rear_right: cmd }
    }
    ...
    pub fn spin_left(speed: i8, max_duty: u32) -> Self {
        ...
        Self::steer(-(s as i8), s as i8, max_duty)
    }
...
mod tests {
    ...
    fn drive_reverse_sets_all_motors_reverse() {
        ...
        for motor in [cmd.front_left, cmd.front_right, cmd.rear_left, cmd.rear_right] {
